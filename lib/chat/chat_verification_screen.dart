...
import 'package:test_app/chat/chat_otp_screen.dart';
                ...
                Container(
                  ...
                  child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        labelStyle:  GoogleFonts.rubik(fontSize: 16.sp,color: AppColors.blackColor),
                 ...
                 child: CircularProgressIndicator(color: AppColors.darkBlueColor,),
                  ...
                  child: DefaultButton(
                   ...
                   if(phone.text.isEmpty){
                     ToastUtils.showCustomToast(context, "Please enter number", AppColors.darkBlueColor);
                     if(mounted){
                       setState(() {
                         loading = false;
                       });
                     ...
                     await FirebaseAuth.instance.verifyPhoneNumber(
                       ...
                       codeSent: (String verificationId, int? resendToken) {
                         ToastUtils.showCustomToast(context, "Code Sent", AppColors.darkBlueColor);
                         if(mounted){
                           setState(() {
                             loading = false;
                           });
                      ...
                      children: [
                        ...
                        TextSpan(text: ' and',
                          style: GoogleFonts.rubik(
                              ...
                              fontSize: 14.sp,
                              color: AppColors.blackColor),),
                        TextSpan(text: ' Privacy Policy',style: GoogleFonts.rubik(
                            fontWeight: FontWeight.w400,
                            fontSize: 14.sp,
                            color: AppColors.darkBlueColor),),
